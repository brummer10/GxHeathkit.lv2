...
static void ref_value_changed(GtkAdjustment *adj, gpointer* args) {
    ...
    gx_HeathkitUI* ui = (gx_HeathkitUI*)arg->ui;
    if (ui->block) {
        ui->block = 0;
        return;
    }
...
static LV2UI_Handle instantiate(const LV2UI_Descriptor*   descriptor,
    ...
    *widget = NULL;
    ...
    const char* plug_name = "GxHeathkit" ;
    ...
    set_expose_func(GX_HEATHKIT_PAINT_BOX(ui->pbox),"pedal_expose");
    ...
    ui->label[0] = gtk_label_new("LEVEL");
    ...
    ui->args[0]->ui = ui;
    ui->args[0]->port_index = (int)LEVEL;
