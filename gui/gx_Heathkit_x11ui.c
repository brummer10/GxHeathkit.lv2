...
static LV2UI_Handle instantiate(const struct _LV2UI_Descriptor * descriptor,
	...
	ui->controls[0] = { 1.0, 1.0, 0.0, 1.0, 1.0, 30, 30, 61, 61, false,"POWER", BSWITCH, BYPASS};
	ui->controls[1] = { 0.5, 0.5, 0.0, 1.0, 0.01, 120, 30, 61, 61, false,"LEVEL", KNOB, LEVEL};
	ui->controls[2] = { 0.5, 0.5, 0.0, 1.0, 0.01, 210, 30, 61, 61, false,"TONE", KNOB, TONE};
